 ...
 * and turning. Top speeds are in m/s — a sailboat's 13 is about 25 knots, which
 * is roughly one ship length a second and reads as genuinely quick.
 */
export const SHIP_CLASSES = {
  sailboat: {
    name: 'Sailboat', tier: 0, cost: 0,
    length: 14, beam: 4.6,
    hp: 100, maxSpeed: 13.0, accel: 2.9, turn: 1.55, angDamp: 3.00,
  ...
  cutter: {
    ...
    hp: 140, maxSpeed: 13.6, accel: 3.0, turn: 1.50, angDamp: 2.95,
    maxBroadside: 4, cargo: 12,
  },
  brigantine: {
    name: 'Brigantine', tier: 2, cost: 1100,
    length: 22, beam: 6.6,
    hp: 200, maxSpeed: 12.6, accel: 2.3, turn: 1.22, angDamp: 2.70,
    maxBroadside: 6, cargo: 18,
  },
  corvette: {
    name: 'Corvette', tier: 3, cost: 2400,
    length: 27, beam: 7.8,
    hp: 280, maxSpeed: 12.0, accel: 2.0, turn: 1.10, angDamp: 2.55,
    maxBroadside: 8, cargo: 24,
  },
  frigate: {
    name: 'Frigate', tier: 4, cost: 4400,
    length: 32, beam: 9.0,
    hp: 350, maxSpeed: 11.4, accel: 1.8, turn: 0.98, angDamp: 2.40,
  ...
  galleon: {
    ...
    hp: 460, maxSpeed: 10.0, accel: 1.6, turn: 0.86, angDamp: 2.25,
    maxBroadside: 12, cargo: 64,
  },
  manofwar: {
    name: 'Man-of-War', tier: 6, cost: 9800,
    length: 44, beam: 12.0,
    hp: 560, maxSpeed: 10.6, accel: 1.4, turn: 0.78, angDamp: 2.10,
    maxBroadside: 15, cargo: 50,
  },
  flagship: {
    name: 'Flagship', tier: 7, cost: 19000,
    length: 56, beam: 15.0,
    hp: 850, maxSpeed: 9.8, accel: 1.1, turn: 0.62, angDamp: 1.90,
    maxBroadside: 20, cargo: 72,
  },
  leviathan: {
    name: 'Leviathan', tier: 8, cost: 38000,
    length: 68, beam: 18.0,
    hp: 1250, maxSpeed: 9.0, accel: 0.95, turn: 0.52, angDamp: 1.80,
